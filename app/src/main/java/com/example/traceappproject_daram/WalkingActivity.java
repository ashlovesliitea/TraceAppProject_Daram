...
public class WalkingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WalkingActivity = com.example.traceappproject_daram.WalkingActivity.this;
        ...
        stopmeasure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent endmeasure = new Intent(com.example.traceappproject_daram.WalkingActivity.this, AnalyzeActivity.class);
