...
public class WalkingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WalkingActivity = com.daram.trace.measure_page.WalkingActivity.this;
        ...
        stopmeasure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent endmeasure = new Intent(com.daram.trace.measure_page.WalkingActivity.this, AnalyzeActivity.class);
